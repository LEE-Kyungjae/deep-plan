...
from deepplan_client import DeepPlanClientOperationError, DeepPlanConflictError, DeepPlanHealthGateError
from deepplan_host_contract import host_action_contract, required_capabilities_for_action, role_has_action_capabilities

from deepplan_reference_adapter import DeepPlanKernelAdapter, summarize_for_host
...
class PlannerHostStep:
    ...
    def run_event(self, planner_output: Dict[str, Any]) -> Dict[str, Any]:
        ...
        except DeepPlanHealthGateError as exc:
            return {
                "ok": False,
                "type": "health_gate",
                "action": str((planner_output or {}).get("action", "")).strip(),
        ...
        except DeepPlanClientOperationError as exc:
